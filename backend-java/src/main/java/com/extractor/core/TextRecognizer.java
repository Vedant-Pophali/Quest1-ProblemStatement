...
public interface TextRecognizer {
     ...
     */
    Optional<FrameResult> recognizeText(String imagePath, String targetText) throws Exception;
     ...
     */
    Optional<Double> recognizeAudioTimestamp(String audioPath, String targetText) throws Exception;
}